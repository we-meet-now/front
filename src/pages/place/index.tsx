...
const ShareIllust = () => (
  ...
  >
    ...
    <path
      d="M100 30C93 30 87 36 87 44C87 55 100 67 100 67C100 67 113 55 113 44C113 36 107 30 100 30Z"
      fill="white"
    />
    <circle cx="100" cy="44" r="5" fill="#3B82F6" />
    {/* Card body */}
    <text x="100" y="104" textAnchor="middle" fill="#111827" fontSize="11" fontWeight="800">
      어디서 만날까요?
    </text>
    <text x="100" y="119" textAnchor="middle" fill="#6B7280" fontSize="9">
      위밋톡 중간위치 찾기
    </text>
    <text x="100" y="132" textAnchor="middle" fill="#3B82F6" fontSize="8">
      wemeettalk.com/meet/···
    </text>
    {/* "링크 공유!" chat bubble (right) */}
    <rect x="106" y="150" width="80" height="22" rx="11" fill="#3B82F6" />
    <text x="146" y="165" textAnchor="middle" fill="white" fontSize="8.5" fontWeight="600">
      링크 공유했어! 🔗
    </text>
    {/* Response bubbles (left) */}
    <rect x="14" y="150" width="80" height="22" rx="11" fill="white" />
    <text x="54" y="165" textAnchor="middle" fill="#374151" fontSize="8.5">
      마포구 입력 ✓
    </text>
    <rect x="14" y="178" width="80" height="18" rx="9" fill="white" />
    <text x="54" y="191" textAnchor="middle" fill="#374151" fontSize="8">
      수원시 입력 ✓
    </text>
  </svg>
);
...
const MidpointIllust = () => (
  ...
  >
    ...
    <text x="46" y="60" textAnchor="middle" fill="white" fontSize="9" fontWeight="800">
      A
    </text>
    {/* Pin B - top right */}
    <circle cx="160" cy="42" r="12" fill="#DBEAFE" />
    <circle cx="160" cy="42" r="8" fill="#5AC8B0" />
    <text x="160" y="46" textAnchor="middle" fill="white" fontSize="9" fontWeight="800">
      B
    </text>
    {/* Pin C - bottom left */}
    <circle cx="40" cy="158" r="12" fill="#DBEAFE" />
    <circle cx="40" cy="158" r="8" fill="#C08BEF" />
    <text x="40" y="162" textAnchor="middle" fill="white" fontSize="9" fontWeight="800">
      C
    </text>
    ...
    <path
      d="M100 78C91 78 84 85 84 95C84 108 100 120 100 120C100 120 116 108 116 95C116 85 109 78 100 78Z"
      fill="#3B82F6"
    />
    <circle cx="100" cy="95" r="6" fill="white" />
    {/* Label */}
    <rect x="62" y="154" width="76" height="18" rx="9" fill="#EFF6FF" />
    <text x="100" y="167" textAnchor="middle" fill="#1D4ED8" fontSize="9" fontWeight="700">
      중간위치 강남역
    </text>
  </svg>
);
...
const RecommendIllust = () => (
  ...
  >
    ...
    <text x="44" y="63" textAnchor="middle" fill="white" fontSize="9" fontWeight="700">
      맛집
    </text>
    <rect x="74" y="50" width="48" height="18" rx="9" fill="#DBEAFE" />
    <text x="98" y="63" textAnchor="middle" fill="#3B82F6" fontSize="9" fontWeight="600">
      카페
    </text>
    <rect x="128" y="50" width="52" height="18" rx="9" fill="#DBEAFE" />
    <text x="154" y="63" textAnchor="middle" fill="#3B82F6" fontSize="9" fontWeight="600">
      문화생활
    </text>
    {/* Place card 1 */}
    <rect
      ...
      strokeWidth="1.5"
    />
    <text x="28" y="92" fill="#111827" fontSize="10" fontWeight="700">
      강남역 분위기 좋은 곳
    </text>
    <text x="28" y="105" fill="#6B7280" fontSize="8.5">
      강남구 · 도보 5분
    </text>
    <rect x="140" y="82" width="36" height="14" rx="7" fill="#EFF6FF" />
    <text x="158" y="93" textAnchor="middle" fill="#3B82F6" fontSize="7.5" fontWeight="700">
      AI 추천
    </text>
    {/* Place card 2 */}
    <rect
      ...
      strokeWidth="1.5"
    />
    <text x="28" y="136" fill="#111827" fontSize="10" fontWeight="700">
      강남 인기 맛집
    </text>
    <text x="28" y="149" fill="#6B7280" fontSize="8.5">
      강남구 · 도보 8분
    </text>
    <rect x="140" y="126" width="36" height="14" rx="7" fill="#EFF6FF" />
    <text x="158" y="137" textAnchor="middle" fill="#3B82F6" fontSize="7.5" fontWeight="700">
      AI 추천
    </text>
    {/* Place card 3 */}
    <rect
      ...
      strokeWidth="1.5"
    />
    <text x="28" y="180" fill="#9CA3AF" fontSize="9.5">
      강남 카페라운지 외 2곳 ···
    </text>
  </svg>
);
...
export const GuestPlaceEntryPage = () => {
  ...
  return (
    <PageLayout
      header={<AppBar title="모임장소 정하기" showBackButton onBackClick={() => navigate('/')} />}
