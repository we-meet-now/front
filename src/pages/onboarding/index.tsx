...
import { JoinMeetingModal } from '@/ui/join-meeting-modal/join-meeting-modal';
...
const CalendarIllust = () => (
  ...
  >
    ...
    <line
      ...
      strokeLinecap="round"
    />
    <text x="100" y="62" textAnchor="middle" fill="white" fontSize="13" fontWeight="700">
      8월
    </text>
    ...
    {[
      ...
      <text key={i} x={x} y={y} textAnchor="middle" fill="#374151" fontSize="11">
        {i + 4}
      </text>
    ))}
...
const MapIllust = () => (
  ...
  >
    ...
    <text x="55" y="79" textAnchor="middle" fill="white" fontSize="9" fontWeight="700">
      A
    </text>
    <circle cx="148" cy="130" r="10" fill="#93C5FD" opacity="0.6" />
    <text x="148" y="134" textAnchor="middle" fill="white" fontSize="9" fontWeight="700">
      B
    </text>
    <circle cx="60" cy="145" r="10" fill="#93C5FD" opacity="0.6" />
    <text x="60" y="149" textAnchor="middle" fill="white" fontSize="9" fontWeight="700">
      C
    </text>
    ...
    <path
      d="M100 58 C91 58 84 65 84 74 C84 86 100 102 100 102 C100 102 116 86 116 74 C116 65 109 58 100 58Z"
      fill="#3B82F6"
    />
...
const SettlementIllust = () => (
  ...
  >
    ...
    <text x="100" y="73" textAnchor="middle" fill="white" fontSize="13" fontWeight="700">
      정산 내역
    </text>
    <rect x="42" y="102" width="116" height="14" rx="4" fill="#EFF6FF" />
    <text x="50" y="113" fill="#374151" fontSize="9">
      🍖 삼겹살
    </text>
    <text x="148" y="113" textAnchor="end" fill="#3B82F6" fontSize="9" fontWeight="700">
      48,000원
    </text>
    <rect x="42" y="122" width="116" height="14" rx="4" fill="#EFF6FF" />
    <text x="50" y="133" fill="#374151" fontSize="9">
      🍺 맥주
    </text>
    <text x="148" y="133" textAnchor="end" fill="#3B82F6" fontSize="9" fontWeight="700">
      24,000원
    </text>
    <line x1="42" y1="146" x2="158" y2="146" stroke="#E5E7EB" strokeWidth="1" />
    <text x="50" y="158" fill="#374151" fontSize="9" fontWeight="700">
      1인당
    </text>
    <text x="148" y="158" textAnchor="end" fill="#3B82F6" fontSize="11" fontWeight="700">
      12,000원
    </text>
    <rect x="55" y="168" width="90" height="22" rx="11" fill="#3B82F6" />
    <text x="100" y="183" textAnchor="middle" fill="white" fontSize="10" fontWeight="700">
      송금하기
    </text>
  </svg>
);
...
const AiManagerIllust = () => (
  ...
  >
    ...
    <text x="61" y="148" textAnchor="middle" fill="#3B82F6" fontSize="9" fontWeight="600">
      일정 확인해요!
    </text>
    <text x="139" y="133" textAnchor="middle" fill="white" fontSize="9" fontWeight="600">
      강남역
    </text>
    <text x="139" y="145" textAnchor="middle" fill="#DBEAFE" fontSize="8">
      어때요? 😊
    </text>
...
export const OnBoardingPage = () => {
  ...
  return (
    <>
      <PageLayout
        ...
        header={
          <header className={styles.brandHeader}>
            <span className={styles.brandHeaderText}>We Meet Talk</span>
      ...
      >
        <div className={styles.topIntro}>
          <div className={styles.logo}>
            <OnboardingLogo className={styles.logoIcon} />
          </div>
        ...
        <div className={styles.buttonContainer}>
          <Button size="l" color="blue" onClick={() => navigate('/create-meeting')}>
            모임 만들기
          </Button>
          <Button size="l" color="white" onClick={() => setShowJoinModal(true)}>
            모임 참여하기
          </Button>
      ...
      {showJoinModal && <JoinMeetingModal onClose={() => setShowJoinModal(false)} />}
    </>
  );
};
